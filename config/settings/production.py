...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["taskban.thedataboy.com", "k-b.herokuapp.com"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Taskban Backend <marmik@thedataboy.com>",
)
